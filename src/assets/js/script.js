(function () {
    ...
    var vehicles = [
        ...
        {'name': 'TSF-W GF', 'number': 'Florian Braunschweig 9-41-43'},
        {'name': 'TSF-W AT', 'number': 'Florian Braunschweig 9-41-43'},
        {'name': 'TSF-W WT', 'number': 'Florian Braunschweig 9-41-43'},
        {'name': 'TSF-W ST', 'number': 'Florian Braunschweig 9-41-43'}
    ];

    var messages = [
        {'src': 0, 'dst': 1, 'announcement': false, msg: 'Hello World!', offset: 5},
        {'src': 2, 'dst': 4, 'announcement': true, msg: 'Hello Earth!', offset: 7},
        {'src': 1, 'dst': 3, 'announcement': false, msg: 'Hello Moon!', offset: 10}
    ];
})();